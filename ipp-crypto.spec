...
Source0  : https://github.com/intel/ipp-crypto/archive/ippcp_2021.12.1/ipp-crypto-2021.12.1.tar.gz
...
%prep
%setup -q -n ipp-crypto-ippcp_2021.12.1
cd %{_builddir}/ipp-crypto-ippcp_2021.12.1
pushd ..
cp -a ipp-crypto-ippcp_2021.12.1 buildavx2
popd
pushd ..
cp -a ipp-crypto-ippcp_2021.12.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720044828
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcrypto_mb.so.11.15
/V3/usr/lib64/libippcp.so.11.15
/V4/usr/lib64/libcrypto_mb.so.11.15
/V4/usr/lib64/libippcp.so.11.15
/usr/lib64/libcrypto_mb.so
/usr/lib64/libcrypto_mb.so.11
/usr/lib64/libcrypto_mb.so.11.15
/usr/lib64/libippcp.so
/usr/lib64/libippcp.so.11
/usr/lib64/libippcp.so.11.15
