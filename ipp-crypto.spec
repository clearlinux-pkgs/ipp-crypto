...
#
Name     : ipp-crypto
Version  : ippcp.2021.7
Release  : 8
URL      : https://github.com/intel/ipp-crypto/archive/refs/tags/ippcp_2021.7.tar.gz
Source0  : https://github.com/intel/ipp-crypto/archive/refs/tags/ippcp_2021.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676479278
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ipp-crypto-ippcp_2021.7/LICENSE %{buildroot}/usr/share/package-licenses/ipp-crypto/30001d543aa58e285d1984caabdd4631f2be514c || :
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build-avx512
