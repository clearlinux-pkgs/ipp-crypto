...
Version  : 2021.10.0
Release  : 20
URL      : https://github.com/intel/ipp-crypto/archive/ippcp_2021.10.0/ipp-crypto-2021.10.0.tar.gz
Source0  : https://github.com/intel/ipp-crypto/archive/ippcp_2021.10.0/ipp-crypto-2021.10.0.tar.gz
...
%prep
%setup -q -n ipp-crypto-ippcp_2021.10.0
cd %{_builddir}/ipp-crypto-ippcp_2021.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703174228
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcrypto_mb.so.11.11
/V3/usr/lib64/libippcp.so.11.11
/V4/usr/lib64/libcrypto_mb.so.11.11
/V4/usr/lib64/libippcp.so.11.11
/usr/lib64/libcrypto_mb.so
/usr/lib64/libcrypto_mb.so.11
/usr/lib64/libcrypto_mb.so.11.11
/usr/lib64/libippcp.so
/usr/lib64/libippcp.so.11
/usr/lib64/libippcp.so.11.11
